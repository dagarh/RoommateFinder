...
export default function Home({ navigation } ) {
  ...
  const listings = [
    ...
    {
      id: 2,
      title: "Charming Studio in Hoboken",
      latitude: 40.7430,
      longitude: -74.0270,
      description: "A quaint studio close to public transit and parks.",
      imageUrl: 'https://example.com/room2.jpg',
      owner: "Louis Armstrong",
      contact: "louis@example.com",
      rent: '2100',
      ...
      SocialPreferences: 'Introvert',
      DailyRoutines: 'Night Owl',
      DescriptionofCurrentOccupants: 'A quiet writer',
    },
    {
      id: 3,
      title: "Spacious Two-Bedroom Flat",
      latitude: 40.7450,
      longitude: -74.0280,
      description: "Roomy flat with great light and modern amenities.",
      imageUrl: 'https://example.com/room3.jpg',
      owner: "Duke Ellington",
      contact: "duke@example.com",
      rent: '3400',
      ...
      SocialPreferences: 'Very Social',
      DailyRoutines: 'Mixed',
      DescriptionofCurrentOccupants: 'Two tech professionals',
    },
    {
      id: 4,
      ...
      latitude: 40.7410,
      longitude: -74.0250,
      description: "Cozy condo overlooking the Hudson River.",
      imageUrl: 'https://example.com/room4.jpg',
      owner: "Billie Holiday",
      contact: "billie@example.com",
      rent: '3200',
      ...
      SocialPreferences: 'Social',
      DailyRoutines: 'Early Bird',
      DescriptionofCurrentOccupants: 'An environmentalist couple',
    },
    {
      id: 5,
      ...
      latitude: 40.7460,
      longitude: -74.0320,
      description: "Perfect space for artists with a dedicated studio area.",
      imageUrl: 'https://example.com/room5.jpg',
      owner: "Charlie Parker",
      contact: "charlie@example.com",
      rent: '2300',
      ...
      SocialPreferences: 'Very Social',
      DailyRoutines: 'Night Owl',
      DescriptionofCurrentOccupants: 'A professional painter',
    },
    {
      id: 6,
      title: "Luxury High-Rise with Skyline Views",
      latitude: 40.7480,
      longitude: -74.0290,
      description: "High-rise building with stunning Manhattan views and all amenities.",
      imageUrl: 'https://example.com/room6.jpg',
      owner: "Thelonious Monk",
      contact: "thelonious@example.com",
      rent: '3600',
      ...
      SocialPreferences: 'Introvert',
      DailyRoutines: 'Early Bird',
      DescriptionofCurrentOccupants: 'A finance professional',
    },
    {
      id: 7,
      title: "Historic Brownstone on Main Street",
      latitude: 40.7420,
      longitude: -74.0300,
      description: "Beautifully restored brownstone with original details and modern comforts.",
      imageUrl: 'https://example.com/room7.jpg',
      owner: "Sarah Vaughan",
      ...
      SocialPreferences: 'Social',
      DailyRoutines: 'Mixed',
      DescriptionofCurrentOccupants: 'History professor and an artist',
    },
    {
      id: 8,
      ...
      latitude: 40.7390,
      longitude: -74.0360,
      description: "Quiet, garden-level unit with private backyard access.",
      imageUrl: 'https://example.com/room8.jpg',
      owner: "Miles Davis",
      contact: "miles@example.com",
      rent: '2800',
      ...
      SocialPreferences: 'Introvert',
      DailyRoutines: 'Night Owl',
      DescriptionofCurrentOccupants: 'Freelance graphic designer',
    },
  ];
